            ...
            return (
              <Form className="register_form w-full flex flex-col items-center">
                ...
                <div className="reg_infos text-xs mt-2.5 text-color__secondary">
                  ...
                  and <span className="text-blue__color">Cookie Policy</span>{" "}
                  You may receive SMS notifications from us and can opt at any
                  time.
                </div>
                <div className="reg_btn_wrapper w-full flex items-center justify-center mb-2.5 mt-5 ">
                  <button
                    type="submit"
                    className="button_presets w-3/4 bg-green__color open_signup"
                  >
                    Sign Up
                  </button>
                </div>
